...
// Страница открываемая по адресу /google. Если адрес другой, то нужно сообщить мне.
// Всё по аналогии с /github.
function GooglePage() {
	...
	useEffect(function () {
		...
		// const url = `http://localhost:5001/api/v1/auth/registration/by-provider?provider=google&code=${code}`
		const url = `https://main.sociable-people.com/api/v1/auth/registration/by-provider?provider=google&code=${code}`
